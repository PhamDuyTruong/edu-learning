          ...
          <Grid item xs={12} md={6}>
            <List>
              <ListItem>
                ...
                <ListItemText primary="Building up the environment" />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Check />
                </ListItemIcon>
                <ListItemText primary="HTML Practices from basic to advance" />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Check />
                </ListItemIcon>
                <ListItemText primary="Build a completed website" />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Check />
          ...
          <Grid item xs={12} md={6}>
            <List>
              <ListItem>
                ...
                <ListItemText primary="Understand Decoration website with CSS " />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Check />
