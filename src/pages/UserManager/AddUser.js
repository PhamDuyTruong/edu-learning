...
import {
  ...
  import {addUser} from '../../actions/UserManageAction';
...
function AddUser(props) {
  ...
  const {error, success, isEdit, tabIndex, selectedUser} = useSelector((state) => state.userManage);
  ...
  let validationSchema = Yup.object().shape({
   ...
   const onAddUser = (values, isEdit, tabIndex, group) =>{
       dispatch(addUser(values, isEdit, tabIndex, group))
   };
